...
/* BASE TEXTURE VTABLE */
@(private)
vtable_address_imm_texture :: proc(this: ^BKPR_Pointer(BKPR_Texture, BKPR_PointerImmutableVTABLE(BKPR_Texture))) -> ^BKPR_Texture {
    fmt.println("Returning immutable texture address!");
    return this^.resource_ref;
}
@(private)
vtable_address_unq_texture :: proc(this: ^BKPR_Pointer(BKPR_Texture, BKPR_PointerUniqueVTABLE(BKPR_Texture))) -> ^BKPR_Texture {
    fmt.println("Returning unique texture address!");
    return this^.resource_ref;
}
@(private)
vtable_dump_imm_texture :: proc(this: ^BKPR_Pointer(BKPR_Texture, BKPR_PointerImmutableVTABLE(BKPR_Texture))) {
    fmt.println("Dumping immutable texture!");
}
@(private)
vtable_dump_unq_texture :: proc(this: ^BKPR_Pointer(BKPR_Texture, BKPR_PointerUniqueVTABLE(BKPR_Texture))) {
    fmt.println("Dumping unique texture!");
}

/* UNIQUE TEXTURE VTABLE */
@(private)
vtable_unique_update_texture :: proc(this: ^BKPR_Pointer(BKPR_Texture, BKPR_PointerUniqueVTABLE(BKPR_Texture)), update_desc: rawptr) {
...
/* BASE TEXT VTABLE */
@(private)
vtable_address_imm_text :: proc(this: ^BKPR_Pointer(BKPR_Text, BKPR_PointerImmutableVTABLE(BKPR_Text))) -> ^BKPR_Text {
    fmt.println("Returning immutable text address!");
    return this^.resource_ref;
}
@(private)
vtable_address_unq_text :: proc(this: ^BKPR_Pointer(BKPR_Text, BKPR_PointerUniqueVTABLE(BKPR_Text))) -> ^BKPR_Text {
    fmt.println("Returning unique text address!");
    return this^.resource_ref;
}
@(private)
vtable_dump_imm_text :: proc(this: ^BKPR_Pointer(BKPR_Text, BKPR_PointerImmutableVTABLE(BKPR_Text))) {
    fmt.println("Dumping immutable text!");
}
@(private)
vtable_dump_unq_text :: proc(this: ^BKPR_Pointer(BKPR_Text, BKPR_PointerUniqueVTABLE(BKPR_Text))) {
